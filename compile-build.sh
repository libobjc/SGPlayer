...
FFMPEG_LIB_FILE_NAME_IOS="lib-iOS"
FFMPEG_LIB_FILE_NAME_MACOS="lib-macOS"
FFMPEG_LIB_FILE_NAME_TVOS="lib-tvOS"
FFMPEG_INCLUDE_FILE_NAME="include"

FFMPEG_LIB_DOWNLOAD_NAME=""
FFMPEG_LIB_DOWNLOAD_NAME_IOS="FFmpeg-"$FFMPEG_VERSION"-lib-iOS"
FFMPEG_LIB_DOWNLOAD_NAME_MACOS="FFmpeg-"$FFMPEG_VERSION"-lib-macOS"
FFMPEG_LIB_DOWNLOAD_NAME_TVOS="FFmpeg-"$FFMPEG_VERSION"-lib-tvOS"
...
do_ffmpeg_lib () {
  ...
  if [ -d LIB_FFMPEG_FILE_PATH ]; then
    ...
    FFMPEG_LIB_DOWNLOAD_URL="http://omw595ki7.bkt.clouddn.com/FFmpeg/$FFMPEG_LIB_DOWNLOAD_NAME.zip"
...
do_ffmpeg_inlcude () {
  ...
  if [ -d INCLUDE_FFMPEG_FILE_PATH ]; then
    ...
    INCLUDE_FFMPEG_DOWNLOAD_URL="http://omw595ki7.bkt.clouddn.com/FFmpeg/$FFMPEG_INCLUDE_DOWNLOAD_NAME.zip"
...
if [ "$ARGV1" == "iOS" ]; then
  ...
  FFMPEG_LIB_DOWNLOAD_NAME=$FFMPEG_LIB_DOWNLOAD_NAME_IOS
  do_ffmpeg_inlcude
  do_ffmpeg_lib
  echo "build iOS done."
  ...
  FFMPEG_LIB_DOWNLOAD_NAME=$FFMPEG_LIB_DOWNLOAD_NAME_MACOS
  do_ffmpeg_inlcude
  do_ffmpeg_lib
  ...
  FFMPEG_LIB_DOWNLOAD_NAME=$FFMPEG_LIB_DOWNLOAD_NAME_TVOS
  do_ffmpeg_inlcude
  do_ffmpeg_lib
