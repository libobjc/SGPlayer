...
- (void)setup
{
    ...
    self.codecContext = [[SGCodecContext alloc] initWithTimebase:cd.timebase codecpar:cd.codecpar frameClass:[SGAudioFrame class]];
...
- (NSArray<__kindof SGFrame *> *)decode:(SGPacket *)packet
{
    ...
    NSArray<SGAudioFrame *> * frames = [self.codecContext decode:packet];
